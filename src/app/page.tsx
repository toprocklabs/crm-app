...
function Card({
  ...
  return (
    <article className="gong-panel gong-kpi rounded-[1.6rem] p-5">
...
export default async function Home() {
  ...
  return (
    ...
    >
      <section className="grid gap-4 xl:grid-cols-[minmax(0,1.7fr)_minmax(320px,0.9fr)]">
        <article className="gong-panel rounded-[1.9rem] p-6">
          <div className="flex flex-wrap items-start justify-between gap-5">
            ...
            <div className="grid min-w-[250px] gap-2 rounded-[1.4rem] border border-slate-200 bg-slate-50 p-4 text-sm">
        ...
        <article className="gong-panel rounded-[1.8rem] p-5">
          ...
          <ul className="mt-4 space-y-3">
            ...
            {dealRows.map((deal) => {
              ...
              return (
                <li key={deal.id} className="rounded-[1.25rem] border border-slate-200 bg-slate-50/70 p-4">
                  <div className="flex items-start justify-between gap-4">
                    <div>
      ...
      <section className="gong-panel rounded-[1.8rem] p-5">
        <div className="flex items-start justify-between gap-4">
          <div>
        ...
        <ul className="mt-4 space-y-3">
          ...
          {activityRows.map((item) => (
            <li key={item.id} className="rounded-[1.2rem] border border-slate-200 bg-slate-50/70 p-4">
